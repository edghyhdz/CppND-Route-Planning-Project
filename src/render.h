...
private:
    ...
    void DrawPathSearched(io2d::output_surface &surface) const; 
    void DrawSearchPoint(io2d::output_surface &surface) const; 
    ...
    io2d::interpreted_path PathLineSearched() const; 
    io2d::brush TestFunction(RouteModel::Node current_node) const; 
